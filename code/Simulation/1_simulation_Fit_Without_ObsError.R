...
for (run in 1:1000){
  ...
  for (i in 1:ncolony){
    ...
    colony_obs_SE_lower <- runif(1,0.2,0.5)
    colony_obs_SE_upper <- colony_obs_SE_lower + runif(1,0.2,0.5)
    ...
    survey_years <- c(survey_years, sample(11:(nyears-11),sample(0:2,1)))
  ...
  ggplot()+
    ...
    ggtitle("Simulated trajectories at colony")+
